...
(function ($) {
    ...
    function getTemplate(_this, ysparent) {
        ...
        return templateList[_this.attr("ys-model-id")];
    }
    ...
    function renderReplace(template, zyyobj) {
        ...
        if (sihtml.indexOf("ys-model") != -1) {
            var $tdiv = $(document.createElement("div")).html(sihtml);
            var cdms = $tdiv.find("[ys-model]");
